...
export interface ApiFilmeFilme extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Palavras_chave: Attribute.JSON &
      Attribute.CustomField<'plugin::tagsinput.tags'>;
    generos: Attribute.Relation<
      'api::filme.filme',
      'oneToMany',
      'api::genero.genero'
    >;
    avaliacaoes_positivas: Attribute.BigInteger;
    avaliacaoes_negativas: Attribute.BigInteger;
    duracao: Attribute.String;
    classificacao: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
